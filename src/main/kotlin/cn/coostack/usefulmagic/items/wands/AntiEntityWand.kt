...
import cn.coostack.usefulmagic.particles.barrages.AntiEntityWandBarrage
    ...
    override fun finishUsing(stack: ItemStack, world: World, user: LivingEntity): ItemStack? {
        ...
        CooParticleAPI.scheduler.runTaskTimerMaxTick(3, maxAge) {
            ...
            repeat(4) {
                ...
                val barrage = AntiEntityWandBarrage(damage, barragePos, world, HitBox.of(1.0, 1.0, 1.0))
