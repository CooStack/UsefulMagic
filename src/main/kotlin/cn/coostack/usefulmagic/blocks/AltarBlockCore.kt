...
class AltarBlockCore(settings: Settings) : BlockWithEntity(settings) {
    override fun getCodec(): MapCodec<out BlockWithEntity?>? {
        return createCodec(::AltarBlockCore)
    }
    ...
    override fun <T : BlockEntity?> getTicker(
        ...
        return validateTicker(type, UsefulMagicBlockEntities.ALTAR_BLOCK_CORE) { world, pos, state, entity ->
