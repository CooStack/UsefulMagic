package cn.coostack.usefulmagic.entity.custom.skills.eye
...
import cn.coostack.usefulmagic.entity.util.phases.eye.EyeHoverPhase
    ...
    override fun holdingTick(
        ...
        if (!firstTick) {
            ...
            ServerSoundManager.instance(
                UsefulMagicSoundEvents.EYE_ACTIVE.get(), SoundSource.HOSTILE
        ...
        ServerSoundManager.instance(
            UsefulMagicSoundEvents.EYE_TELEPORT.get(), SoundSource.HOSTILE
        ).layer("teleport")
            .uniqueKey("teleport:${holdingEntity.uuid}:$holdTicks")
            .entity(holdingEntity)
            .pitch(1f)
            .volume(0.5f)
            .visibleRange(256.0)
