...
import cn.coostack.usefulmagic.entity.custom.goal.eye.MagicSubEyeAttackGoal
import cn.coostack.usefulmagic.entity.custom.skills.eye.sub.EyeSuicideAttackSkill
...
class MagicSubEyeEntity(
            ...
            addGoal(
                ...
                NearestAttackableTargetGoal(
                    ...
                    !player.hasInfiniteMaterials() &&
                            !player.isSpectator &&
                            this@MagicSubEyeEntity.distanceToSqr(player) <= 64.0 * 64.0
                }
            )
        }
    ...
    fun tryFollowOwner(): Boolean {
        ...
        deltaMovement = FlightMovementUtil.maintainOffset(
            ...
            target = currentOwner.positionOnEye(),
            acceleration = 0.4,
            damping = 0.82,
            4.0 minRangeTo 8.0,
            -2.0 minRangeTo 2.0
