...
class MagicSubEyeEntityRenderer(context: EntityRendererProvider.Context) : EntityRenderer<MagicSubEyeEntity>(context) {
    companion object {
        private val PEARL_TEXTURE = ResourceLocation.withDefaultNamespace(
        ...
        private const val VISUAL_SCALE = 0.7f
    ...
    override fun getTextureLocation(entity: MagicSubEyeEntity): ResourceLocation {
        return PEARL_TEXTURE
    }
