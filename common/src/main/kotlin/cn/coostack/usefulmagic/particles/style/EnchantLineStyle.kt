...
class EnchantLineStyle(
    ...
    class Provider : ParticleStyleProvider {
        override fun createStyle(
            ...
            val lifetime = args["maxAge"]!!.loadedValue as Int
    ...
    override fun writePacketArgs(): Map<String, ParticleControlerDataBuffer<*>> {
        return mapOf(
            ...
            "maxAge" to Buffers.int(lifetime),
    ...
    override fun readPacketArgs(args: Map<String, ParticleControlerDataBuffer<*>>) {
        ...
        args["maxAge"]?.let { lifetime = it.loadedValue as Int }
    ...
    private fun withEffect(): StyleData = StyleData {
        ...
        if (fade) {
            ...
            if (fadeOutTick <= lifetime) {
                ...
                // 设置fadeout
                addPreTickAction {
                    if (this@EnchantLineStyle.current !in this@EnchantLineStyle.lifetime - fadeOutTick..this@EnchantLineStyle.lifetime) {
                        return@addPreTickAction
                    }
                    particle.particleAlpha -= step
                }
