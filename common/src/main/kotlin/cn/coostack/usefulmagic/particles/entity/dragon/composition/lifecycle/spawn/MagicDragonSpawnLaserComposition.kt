...
@CooAutoRegister
class MagicDragonSpawnLaserComposition(position: Vec3, world: Level? = null) : AutoParticleComposition(position, world) {
    @CodecField
    ...
    private val scaleHelper = CompositionBezierScaleHelper(10, 0.01, 1.0, RelativeLocation(3.837472, 1.165466, 0.0), RelativeLocation(3.848758, 1.119329, 0.0))
                        ...
                        ParticleShapeComposition(it).apply {
                            ...
                            applyBuilder(
                                PointsBuilder()
                                    ...
                                    .addBuilder(RelativeLocation(0.0, 0.0, 0.0),
                                        PointsBuilder()
                                            .addBuilder(RelativeLocation(2.5, 0.0, 4.330127),
                                                PointsBuilder()
                                                    .addCircle(1.0, 60)
                                                    ...
                                                    .rotateTo(RelativeLocation(0.0, 0.0, 0.0), RelativeLocation(-2.5, 0.0, -4.330127))
                                            ...
                                            .addBuilder(RelativeLocation(-5.0, 0.0, 0.0),
                                                PointsBuilder()
                                                    .addCircle(1.0, 60)
                                                    .addPolygonInCircle(3, 15, 1.0)
                                                    .addBuilder(RelativeLocation(0.0, 0.0, 0.0),
                                                    ...
                                                    .axis(RelativeLocation(0.0, 0.0, 1.0))
                                                    .rotateTo(RelativeLocation(0.0, 0.0, 0.0), RelativeLocation(5.0, 0.0, 0.0))
                                    ...
                                    .addBuilder(RelativeLocation(0.0, 0.0, 0.0),
                                        PointsBuilder()
                                            .addBuilder(RelativeLocation(5.196152, 0.0, 3.0),
                                                PointsBuilder()
                                                    .addBuilder(RelativeLocation(0.0, 0.0, 0.0),
                                                        PointsBuilder()
                                                            .addLine(RelativeLocation(0.0, 0.0, 1.0), RelativeLocation(0.0, 0.0, -1.0), 10)
                                                            .addLine(RelativeLocation(0.0, 0.0, 1.0), RelativeLocation(-0.75, 0.0, 0.5), 10)
                                                            .addLine(RelativeLocation(-0.75, 0.0, 0.5), RelativeLocation(0.0, 0.0, 0.0), 10)
                                                            .addLine(RelativeLocation(0.0, 0.0, 0.0), RelativeLocation(-0.75, 0.0, -0.625), 10)
                                                            .addLine(RelativeLocation(-0.75, 0.0, -0.625), RelativeLocation(0.0, 0.0, -1.0), 10)
                                                            .scale(0.7)
                                                    )
                                                ...
                                                PointsBuilder()
                                                    .addBuilder(RelativeLocation(0.0, 0.0, 0.0),
                                                        PointsBuilder()
                                                            ...
                                                            .addLine(RelativeLocation(0.0, 0.0, 0.291667), RelativeLocation(0.0, 0.0, -0.75), 10)
                                                            .addLine(RelativeLocation(0.375, 0.0, -0.125), RelativeLocation(-0.375, 0.0, -0.125), 10)
                                                            .addRadian(RelativeLocation(0.004853, 0.0, 1.944586), 0.5, 10, 0.0, 1.0*PI, 1.0*PI)
                                                            .scale(0.7)
                                                    )
                                            ...
                                            .addBuilder(RelativeLocation(0.0, 0.0, -6.0),
                                                PointsBuilder()
                                                    .addBuilder(RelativeLocation(0.0, 0.0, 0.0),
                                                        PointsBuilder()
                                                            .addLine(RelativeLocation(0.5, 0.0, -1.0), RelativeLocation(0.0, 0.0, 0.0), 10)
                                                            .addLine(RelativeLocation(-0.5, 0.0, -1.0), RelativeLocation(0.0, 0.0, 0.0), 10)
                                                            .addLine(RelativeLocation(0.5, 0.0, 1.0), RelativeLocation(0.0, 0.0, 0.0), 10)
                                                            .addLine(RelativeLocation(-0.5, 0.0, 1.0), RelativeLocation(0.0, 0.0, 0.0), 10)
                                                            .addLine(RelativeLocation(0.5, 0.0, 1.0), RelativeLocation(0.5, 0.0, -1.0), 10)
                                                            .addLine(RelativeLocation(-0.5, 0.0, 1.0), RelativeLocation(-0.5, 0.0, -1.0), 10)
                                                            .scale(0.7)
                                                    )
                                                    .pointsOnEach { it.add(0.0, 0.0, 0.0) }
                            ...
                            loadScaleHelperBezierValue(0.01, 1.0, 10, RelativeLocation(3.837472, 1.155466, 0.0), RelativeLocation(-6.151242, 0.119329, 0.0))
                            applyDisplayAction {
                                addPreTickAction {
