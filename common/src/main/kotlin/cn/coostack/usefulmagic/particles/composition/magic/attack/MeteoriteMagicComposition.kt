...
class MeteoriteMagicComposition(position: Vec3, world: Level? = null) :
                                                    ...
                                                    applyBuilder(
                                                        ...
                                                        CompositionData()
                                                            ...
                                                            .addCParticleInstanceInit {
                                                                ...
                                                                size = 0.5F
                                                                color = this@MeteoriteMagicComposition.color
                                                            }
                            ...
                            applyBuilder(
                                ...
                                CompositionData()
                                    ...
                                    .addCParticleControlerInstanceInit {
                                        var time: Float = 0.0F
                                        addPreTickAction {
                                            if (this@MeteoriteMagicComposition.status.isEnable()) {
                                                time++
                                                setAlpha(time / 20)
                                            }
                                        }
    ...
    override fun onDisplay() {
        ...
        addPreTickAction {
            ...
            if (status.isDisable()) {
                playCParticleAlphaTransition(20f, CParticleCurve.linear(1f, 0.1f))
            }
            toggleRelative()
        }
    }
