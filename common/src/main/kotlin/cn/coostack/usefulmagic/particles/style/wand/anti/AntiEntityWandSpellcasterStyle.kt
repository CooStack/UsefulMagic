...
class AntiEntityWandSpellcasterStyle(
    ...
    override fun onDisplay() {
        ...
        addPreTickAction {
            ...
            if (!client && statusHelper.displayStatus != 2 && !player.useItem.isOf(UsefulMagicItems.ANTI_ENTITY_WAND)) {
    ...
    private fun getPlayer(): Player? = world?.getPlayerByUUID(bindPlayer)
